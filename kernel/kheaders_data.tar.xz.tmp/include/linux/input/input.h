...
#define SET_BOOSTER  { \
	...
	set_hmp(value); \
	set_qos(&_this->cpu_qos, PM_QOS_CLUSTER1_FREQ_MIN, _this->param[_this->index].cpu_freq);  \
	set_qos(&_this->kfc_qos, PM_QOS_CLUSTER0_FREQ_MIN, _this->param[_this->index].kfc_freq);  \
...
//______________________________________________________________________________	input_booster,type = <4>;	
