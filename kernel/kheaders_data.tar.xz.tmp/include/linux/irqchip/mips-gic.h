...
#define GIC_LOCAL_INT_WD	0 
#define GIC_LOCAL_INT_COMPARE	1 
#define GIC_LOCAL_INT_TIMER	2 
#define GIC_LOCAL_INT_PERFCTR	3 
#define GIC_LOCAL_INT_SWINT0	4 
#define GIC_LOCAL_INT_SWINT1	5 
#define GIC_LOCAL_INT_FDC	6 
