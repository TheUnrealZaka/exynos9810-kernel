...
enum {
	NVMF_RDMA_QPTYPE_CONNECTED	= 0, 
	NVMF_RDMA_QPTYPE_DATAGRAM	= 1, 
};


enum {
	NVMF_RDMA_PRTYPE_NOT_SPECIFIED	= 0, 
	NVMF_RDMA_PRTYPE_IB		= 1, 
	NVMF_RDMA_PRTYPE_ROCE		= 2, 
	NVMF_RDMA_PRTYPE_ROCEV2		= 3, 
	NVMF_RDMA_PRTYPE_IWARP		= 4, 
};


enum {
	NVMF_RDMA_CMS_RDMA_CM	= 0, 
};
