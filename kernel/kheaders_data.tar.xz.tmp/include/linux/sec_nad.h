...
typedef struct{
	volatile u64 target_addr;	
	volatile u64 expected_val;	
	volatile u64 read_val;		
...
struct nad_env {
	...
	nad_fail_information nad_fail_info;				
	nad_fail_information nad_second_fail_info;		
	nad_fail_information nad_acat_fail_info;		
	nad_fail_information nad_acat_second_fail_info;	
